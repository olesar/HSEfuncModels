...
<a href="ДЗ_инфструктура.pdf">Link</a>. Срок сдачи 20 декабря (на семинаре). Онлайн-сдача: https://lms.hse.ru, на странице дисциплины вкладка Проекты > Информационная структура и порядок слов  
...
#### Экзамен
* Ссылка для сдачи экзаменационного проекта: https://lms.hse.ru, на странице дисциплины вкладка Проекты > Экзаменационный проект  
